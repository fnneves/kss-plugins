...
- **`last_session` is stamped in both PROJECT.md and topic STATE.md — deliberate denormalization.** The project file answers "when did I last touch this project" in one read; the topic file scopes it per track. Not a bug; keep both in sync.
